...
const MODULES = [
    ...
    "vomit", "amenities", "needs", "thoughts", "ops", "op-ranges", "cooldown", "cash-gate", "facilities", "queues",
    "entertainer-targeting", "marketing", "staff-hiring", "deferred", "settings", "breakdown-trace", "cheap-builds", "queue-tv", "extras-budget", "repairs", "court-extras",
];
