# Performance — Field Log (archived)

Session-by-session field measurements, case studies and bug write-ups, moved verbatim out of [performance.md](../performance.md) on 2026-09-24 to keep that file a short reference. Nothing was edited.
